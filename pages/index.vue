        ...
        <div class="md:mb-8 flex flex-col items-center flex-grow w-full max-w-lg px-3 pt-8">
          ...
          >
            <div class="px-6 py-4">
              ...
              <div
                class="dark:bg-neutral-750 dark:border-transparent dark:shadow-md bg-gray-50 px-4 py-2 my-2 border border-gray-200 rounded-lg"
              >
                ...
                <div class="pl-2">
                  ...
                  <div class="flex flex-wrap">
                    ...
                    <a
                      class="skill nuxtjs flex items-center justify-center p-4 mb-1 mr-1 rounded-full"
                ...
                <div class="pl-2 mt-2">
                  ...
                  <div class="flex flex-wrap">
                    ...
                    <a
                      class="skill laravel flex items-center justify-center p-4 mb-1 mr-1 rounded-full"
                    ...
                    <a
                      class="skill adonis flex items-center justify-center p-4 mb-1 mr-1 rounded-full"
                ...
                <div class="pl-2 mt-2">
                  ...
                  <div class="flex flex-wrap">
                    ...
                    <a
                      class="skill postgres flex items-center justify-center p-4 mb-1 mr-1 rounded-full"
                    ...
                    <a
                      class="skill mongo flex items-center justify-center p-4 mb-1 mr-1 rounded-full"
                    ...
                    <a
                      class="skill redis flex items-center justify-center p-4 mb-1 mr-1 rounded-full"
                      href="https://redis.io/"
                      target="_blank"
                    >
              ...
              >
                ...
                <div class="pl-2">
                  <div class="flex flex-wrap">
                    ...
                    <a
                      class="skill typescript flex items-center justify-center p-4 mb-1 mr-1 rounded-full"
                    ...
                    >
                      ...
                      >
                        <g id="original">
                          <rect fill="transparent" x="22.67" y="47" width="99.67" height="73.67" />
                          <path
                            id="original-2"
                            data-name="original"
                            fill="currentColor"
