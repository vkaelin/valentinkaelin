  ...
  >
    <div class="flex items-center">
      <img
        ...
        class="w-auto h-12"
      />
      <span class="text-2xl font-light whitespace-no-wrap">{{ project.title }}</span>
    </div>
    <div class="w-full my-3">
      ...
      <div class="text-sm leading-loose">
        <div class>
          ...
          <template v-for="(tech, index) in project.techs" :key="tech + project.title">
            <span
        ...
        <div class>
          ...
          <span class="dark:text-gray-400 text-gray-800">
            {{ project.from }}
            <template v-if="project.to">- {{ project.to }}</template>
          </span>
        </div>
      </div>
    </div>
