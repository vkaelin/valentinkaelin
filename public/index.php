...
<body>
  ...
  <div class="modal-discord fixed w-full z-40 items-center h-screen px-2 hidden">
    <div class="relative max-w-sm mx-auto w-full bg-white rounded-lg px-6 py-10 dark:bg-dark-3">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        class="absolute pin-r pin-t text-indigo fill-current h-10 w-10 cursor-pointer rounded-full flex items-center justify-center hover:bg-indigo-lightest mr-1 mt-1"
        id="closeDiscord">
        <path fill-rule="evenodd"
          d="M15.78 14.36a1 1 0 0 1-1.42 1.42l-2.82-2.83-2.83 2.83a1 1 0 1 1-1.42-1.42l2.83-2.82L7.3 8.7a1 1 0 0 1 1.42-1.42l2.83 2.83 2.82-2.83a1 1 0 0 1 1.42 1.42l-2.83 2.83 2.83 2.82z" />
      </svg>
      <div
        class="bg-grey-lightest px-4 py-6 border border-grey-lighter rounded-lg my-2 dark:bg-dark-4 dark:border-transparent">
  ...
  <main class="h-screen">
    <div
      class="back-to-top fixed w-10 h-10 pin-b pin-r mr-4 mb-4 flex aligns-items justify-center bg-white border-2 border-indigo text-indigo opacity-0 dark:bg-dark-4 dark:text-dark-primary dark:border-indigo-light hover:bg-indigo-light hover:text-white"
      style="transform: rotate(45deg);">
      <span class="self-center font-sans font-light" style="transform: rotate(-45deg);">Top</span>
    </div>
    <div
      class="flex flex-col md:flex-row items-center md:items-start justify-center min-h-screen font-sans font-light leading-normal">
      ...
      <div class="flex flex-col flex-grow items-center max-w-sm w-full md:mb-8 px-3 pt-8">
        ...
        <div class="w-full bg-white shadow rounded my-2 dark:bg-dark-2 dark:text-dark-primary">
          <div class="sm:flex sm:items-center px-6 pt-4">
            <img src="img/me.jpg"
              class="shadow block h-16 sm:h-24 rounded-full mx-auto mb-4 sm:mb-0 sm:mr-4 sm:ml-0 self-start"
              alt="Profile picture">
            <div class="sm:flex-grow">
              <div class="text-center sm:text-left mb-4">
                ...
                <p class="my-2 text-sm leading-tight text-grey-dark sm:text-justify dark:text-dark-secondary">
                  ...
                  <br> Me contacter de préfèrence à l'email suivante: <a
                    class="text-grey-dark border-b border-dashed pb-px no-underline dark:text-dark-secondary"
          ...
          <div class="flex flex-wrap justify-around px-3 py-3 border-t border-grey-lighter dark:border-dark-4">
            <a href="mailto:contact@valentinkaelin.ch"
              class="mx-1 my-1 no-underline text-xs font-semibold rounded-full px-3 py-1 border border-blue-dark text-blue-dark hover:bg-blue-dark hover:text-white dark:border-indigo-light dark:bg-indigo-light dark:text-white btn">Email</a>
            <a href="https://www.linkedin.com/in/valentin-kaelin-659759157/" target="_blank"
              class="mx-1 my-1 no-underline text-xs font-semibold rounded-full px-3 py-1 border border-blue text-blue hover:bg-blue hover:text-white dark:border-indigo-light dark:bg-indigo-light dark:text-white btn">LinkedIn</a>
            <span id="openDiscord"
              class="mx-1 my-1 no-underline text-xs font-semibold rounded-full px-3 py-1 border border-indigo text-indigo cursor-pointer hover:bg-indigo hover:text-white cursor-pointer dark:border-indigo-light dark:bg-indigo-light dark:text-white btn">Discord</span>
            <a href="https://github.com/Kalaneee" target="_blank"
              class="mx-1 my-1 no-underline text-xs font-semibold rounded-full px-3 py-1 border border-grey-darkest text-grey-darkest hover:bg-grey-darkest hover:text-white dark:border-indigo-light dark:bg-indigo-light dark:text-white btn">GitHub</a>
        ...
        <div class="w-full bg-white shadow rounded my-2 dark:bg-dark-2 dark:text-dark-primary">
          <div class="px-6 py-4">
            ...
            <div
              ...
              <a href="http://www.42.fr/" target="_blank"
                class="self-end no-underline text-xs font-semibold rounded-full px-4 py-1 -mt-4 mb-1 border border-indigo text-indigo hover:bg-indigo hover:text-white dark:border-indigo-light dark:bg-indigo-light dark:text-white btn">Site</a>
            </div>
            <div
              class="flex flex-col bg-grey-lightest px-4 py-2 mt-2 mb-4 border border-grey-lighter rounded-lg dark:bg-dark-3 dark:border-transparent dark:shadow-md">
        ...
        <div class="w-full bg-white shadow rounded my-2 dark:bg-dark-2 dark:text-dark-primary">
          <div class="px-6 py-4">
            ...
            <div
              ...
              <div class="pl-2 mb-2">
                <div
                  class="inline-block text-base text-grey-darker border-b border-dashed indigo-circle mb-1 dark:text-dark-secondary">
                  Front-End</div>
                <div class="flex flex-wrap">
                  <a class="skill html flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                  ...
                  <a class="skill css flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                    href="https://www.w3.org/Style/CSS/Overview.en.html" target="_blank">
                  ...
                  <a class="skill js flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                  ...
                  <a class="skill tailwind flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                    href="https://tailwindcss.com/docs/what-is-tailwind/" target="_blank">
                    ...
                    <svg viewBox="0 0 64 64" class="text-indigo fill-current w-10 dark:text-indigo-light">
                      <path
                        ...
                        fill-rule="evenodd" stroke-width="1.6" />
                    </svg>
                  </a>
                  <a class="skill bootstrap flex items-center justify-center p-4 rounded-full mb-1 mr-1"
              ...
              <div class="pl-2">
                <div
                  ...
                  Back-End</div>
                <div class="flex flex-wrap">
                  <a class="skill php flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                    href="http://www.php.net/" target="_blank">
                  ...
                  <a class="skill mysql flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                  ...
                  <a class="skill ror flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                  ...
                  <a class="skill nodejs flex items-center justify-center p-4 rounded-full mb-1 mr-1"
            ...
            <div
              ...
              <div class="pl-2">
                <div class="flex flex-wrap">
                  <a class="skill java flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                    href="https://docs.oracle.com/javase/7/docs/technotes/guides/language/index.html" target="_blank">
                  ...
                  <a class="skill csharp flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                    href="https://docs.microsoft.com/en-us/dotnet/csharp/index" target="_blank">
            ...
            <div
              ...
              <div class="pl-2">
                <div class="flex flex-wrap">
                  <a class="skill photoshop flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                    href="https://www.adobe.com/ch_fr/products/photoshop.html" target="_blank">
                  ...
                  <a class="skill xd flex items-center justify-center p-4 rounded-full mb-1 mr-1"
                    href="https://www.adobe.com/ch_fr/products/xd.html" target="_blank">
        ...
        <div
          class="hidden md:flex md:flex-row items-center text-xs sm:text-sm text-grey-lighter text-center justify-center py-4 max-w-sm w-full px-4 dark:text-dark-secondary">
          <div>
            <a href="https://valentinkaelin.ch"
              class="no-underline text-grey-lighter hover:text-grey hover:underline dark:text-dark-secondary">valentinkaelin.ch</a>
      ...
      <div class="flex flex-col flex-grow items-center max-w-sm w-full md:mb-8 px-3 pt-8">
        ...
        <div
          ...
          <div class="w-full my-3">
            ...
            <div class="leading-loose">
              <div class="text-sm">
                ...
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">Ruby
                  on Rails</span>,
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">Action
                  Cable</span>,
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">SASS</span>
              </div>
              <div class="text-sm">
                Date :
          ...
          <a href="https://youtogether.herokuapp.com" target="_blank"
        ...
        <div
          ...
          <div class="w-full my-3">
            ...
            <div class="leading-loose">
              <div class="text-sm">
                ...
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">WordPress</span>,
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">PHP</span>,
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">MySQL</span>,
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">Bootstrap</span>
              </div>
              <div class="text-sm">
                Date :
          ...
          <a href="https://associationciao.ch/" target="_blank"
            class="sm:self-end no-underline text-xs font-semibold rounded-full px-4 py-1 border border-indigo text-indigo hover:bg-indigo hover:text-white dark:border-indigo-light dark:bg-indigo-light dark:text-white btn">
            Voir le site
          </a>
        ...
        <div
          ...
          <div class="w-full my-3">
            ...
            <div class="leading-loose">
              <div class="text-sm">
                Technologie utilisée :
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">TailwindCSS</span>,
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">PHP</span>
              </div>
              <div class="text-sm">
          ...
          <a href="http://3lementair.ch/" target="_blank"
            class="sm:self-end no-underline text-xs font-semibold rounded-full px-4 py-1 border border-indigo text-indigo hover:bg-indigo hover:text-white dark:border-indigo-light dark:bg-indigo-light dark:text-white btn">
            Voir le site
          </a>
          ...
          <div class="w-full my-3">
            ...
            <div class="leading-loose">
              <div class="text-sm">
                Technologies utilisées :
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">Java</span>,
                <span
                  class="text-grey-darker border-b border-dashed pb-px dark:text-dark-disabled dark:border-dark-disabled">jbox2d</span>
              </div>
              <div class="text-sm">
                Date :
        ...
        <div
          class="flex md:hidden md:flex-row items-center text-xs sm:text-sm text-grey-lighter text-center justify-center py-4 max-w-sm w-full px-4 dark:text-dark-secondary">
          <div>
            <a href="https://valentinkaelin.ch"
              class="no-underline text-grey-lighter hover:text-grey hover:underline dark:text-dark-secondary">valentinkaelin.ch</a>
            &copy; 2017 - 2019 | Tous droits réservés.
