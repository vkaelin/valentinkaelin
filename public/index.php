        ...
        <div class="w-full bg-white shadow rounded my-2">
          <div class="px-6 py-4">
            ...
            <div class="pl-2 pr-2">
              ...
              <div class="pl-2">
                <div class="text-base text-grey-darker">Front-End</div>
                <div class="flex flex-wrap">
                  <a class="skill html flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                  ...
                  <a class="skill css flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill js flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill sass flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill tailwind flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                  ...
                  <a class="skill bootstrap flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
              ...
              <div class="pl-2">
                <div class="text-base text-grey-darker">Back-End</div>
                <div class="flex flex-wrap">
                  <a class="skill php flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill mysql flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill ror flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill nodejs flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
            ...
            <div class="pl-2 pr-2">
              ...
              <div class="pl-2">
                <div class="flex flex-wrap">
                  <a class="skill java flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill csharp flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
            ...
            <div class="pl-2 pr-2">
              ...
              <div class="pl-2">
                <div class="flex flex-wrap">
                  <a class="skill photoshop flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill xd flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="#">
