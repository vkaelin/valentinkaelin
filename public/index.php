  ...
  <main class="h-screen">
    ...
    <div class="flex flex-col md:flex-row items-center md:items-start justify-center min-h-screen font-sans font-light leading-normal">
      ...
      <div class="flex flex-col flex-grow items-center max-w-sm w-full md:mb-8 px-3 pt-8">
        ...
        <div class="w-full bg-white shadow rounded my-2">
          <div class="px-6 py-4">
            ...
            <div class="px-2 bg-grey-lightest my-2 border border-grey-lighter rounded-lg">
              <div class="text-lg">Web</div>
              <div class="pl-2 mb-2">
                <div class="inline-block text-base text-grey-darker border-b border-dashed indigo-circle mb-1">Front-End</div>
                <div class="flex flex-wrap">
                  <a class="skill html flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://www.w3.org/html/"
                    target="_blank">
                    <span class="sr-only">HTML</span>
                    <svg viewBox="0 0 128 128" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill css flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://www.w3.org/Style/CSS/Overview.en.html"
                    target="_blank">
                  ...
                  <a class="skill js flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript"
                    target="_blank">
                  ...
                  <a class="skill sass flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://sass-lang.com/"
                    target="_blank">
                  ...
                  <a class="skill tailwind flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://tailwindcss.com/docs/what-is-tailwind/"
                    target="_blank">
                    <span class="sr-only">TailwindCSS</span>
                    <svg viewBox="0 0 64 64" class="text-indigo fill-current w-10">
                  ...
                  <a class="skill bootstrap flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://getbootstrap.com/"
                    target="_blank">
              ...
              <div class="pl-2">
                <div class="inline-block text-base text-grey-darker border-b border-dashed indigo-circle mb-1">Back-End</div>
                <div class="flex flex-wrap">
                  <a class="skill php flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="http://www.php.net/"
                    target="_blank">
                  ...
                  <a class="skill mysql flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://www.mysql.com"
                    target="_blank">
                  ...
                  <a class="skill ror flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://rubyonrails.org/"
                    target="_blank">
                  ...
                  <a class="skill nodejs flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://nodejs.org"
                    target="_blank">
            ...
            <div class="px-2 bg-grey-lightest my-2 border border-grey-lighter rounded-lg">
              ...
              <div class="pl-2">
                <div class="flex flex-wrap">
                  <a class="skill java flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://docs.oracle.com/javase/7/docs/technotes/guides/language/index.html"
                    target="_blank">
                  ...
                  <a class="skill csharp flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://docs.microsoft.com/en-us/dotnet/csharp/index"
                    target="_blank">
            ...
            <div class="px-2 bg-grey-lightest my-2 border border-grey-lighter rounded-lg">
              ...
              <div class="pl-2">
                <div class="flex flex-wrap">
                  <a class="skill photoshop flex items-center justify-center p-4 rounded-full mb-1 mr-1" href="https://www.adobe.com/ch_fr/products/photoshop.html"
                    target="_blank">
      ...
      <div class="flex flex-col flex-grow items-center max-w-sm w-full md:mb-8 px-3 pt-8">
        ...
        <div class="flex flex-col items-center w-full bg-white rounded shadow px-4 py-4 my-2">
          <div class="flex items-center">
            <img src="img/3lementair.png" class="w-auto h-12" alt="3lément'Air SA">
          </div>
          <div class="w-full my-3">
            <p class="text-sm text-justify mb-2 px-4 py-1 -mx-4 bg-grey-lightest">
